...
\begin{center}
    \begin{tabular}{| c | c |}
        \hline
        Name: & Make Local Transaction \\
        \hline
        Actors: & Customer, Compliance Officer \\
        \hline
        Goals: & For Customer: To transfer funds to another account within the same country (local).
        For Compliance Officer: To ensure that local transactions comply with regulatory \\
